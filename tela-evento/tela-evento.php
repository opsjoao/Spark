<?php
require_once('../formulario-login/verificacao.php');
...
// Busca os detalhes do Evento Específico
$stmt_evento = $conexao->prepare("
    SELECT e.*, p.nome AS nome_parque FROM Evento AS e
    JOIN Parque AS p ON e.idParque = p.idParque WHERE e.idEvento = ?
");
...
// Busca as Avaliações do Parque deste evento
$stmt_avaliacoes = $conexao->prepare("
    SELECT av.*, u.nome, u.username, u.avatar_path FROM Avaliacao_parque AS av
    JOIN Usuario AS u ON av.idUsuario = u.idUsuario WHERE av.idParque = ? ORDER BY av.idAvaliacao DESC
");
    ...
    <main>
        <div class="event-container">
            <?php if (!empty($evento['imagem_path'])): ?>
                <img src="/Spark-main/<?php echo htmlspecialchars($evento['imagem_path']); ?>" alt="Imagem do Evento" class="event-image">
            <?php endif; ?>
            <div class="event-info">
                ...
                <button class="cta-button">Confirmar Presença</button>
            </div>
        </div>
                ...
                <div class="review-card">
                    ...
                    <div class="review-content">
                        <div class="review-header">
                            ...
                            <span>@<?php echo htmlspecialchars($avaliacao['username']); ?></span>
                        </div>
                        <div class="stars">
