...
<body>
    ...
    <nav class="bottombar">
        ...
        <button class="nav-btn" onclick="window.location.href='/Spark-main/teladeusuario.php'"><i class="fa-solid fa-user"></i><span></span></button>
    </nav>
    ...
    <script src="tela-evento.js"></script>
</body>
</html>
<?php
$stmt_evento->close();
